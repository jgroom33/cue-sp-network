...
agg4: device.#Device & {
	...
	interfaces: [
		{name: "lo0", type: "loopback", ipv4: "10.0.0.15/32"},
		{name: "eth1", type: "physical", ipv4: "10.1.0.31/31", description: "to-pe2-nni"},
		{name: "eth2", type: "physical", ipv4: "10.2.4.0/31", description: "to-ce1"},
	]
	...
	sr_config: {
		...
		node_sids: [{index: 15, prefix: "10.0.0.15/32"}]
		adj_sids: [
			{label: 15001, interface: "eth1", neighbor: "10.1.0.30"},
		]
	}
	...
	bfd_config: {
		...
		sbfd_reflector: {discriminator: 100015}
	}
	...
	// --- Management VRF ---
	mgmt_vrf: {interface: "mgmt0", ipv4: "10.100.0.15/24", gateway: "10.100.0.254"}
}
