...
p3: device.#Device & {
	...
	interfaces: [
		{name: "lo0", type: "loopback", ipv4: "10.0.0.7/32"},
		{name: "eth1", type: "physical", ipv4: "10.1.0.11/31", description: "to-p1"},
	...
	sr_config: {
		...
		node_sids: [{index: 7, prefix: "10.0.0.7/32"}]
		adj_sids: [
			{label: 15001, interface: "eth1", neighbor: "10.1.0.10"},
	...
	// --- Management VRF ---
	mgmt_vrf: {interface: "mgmt0", ipv4: "10.100.0.7/24", gateway: "10.100.0.254"}
}
