...
rr1: device.#Device & {
	...
	interfaces: [{name: "lo0", type: "loopback", ipv4: "10.0.0.5/32"}]
	...
	sr_config: {
		...
		node_sids: [{index: 5, prefix: "10.0.0.5/32"}]
	}
	...
	bfd_config: {
		...
		sbfd_reflector: {discriminator: 100005}
	}
	...
	bgp_config: {
		asn: 65000, router_id: "10.0.0.5"
		is_route_reflector: true, cluster_id: "10.0.0.5"
		...
		neighbors: [
			...
			{address: "10.0.0.6", remote_as: 65000, peer_type: "internal", update_source: "lo0", address_families: ["ipv4-unicast", "l3vpn-ipv4", "evpn"], description: "to-rr2-peer"},
		]
	}
	...
	// --- Management VRF ---
	mgmt_vrf: {interface: "mgmt0", ipv4: "10.100.0.5/24", gateway: "10.100.0.254"}
}
