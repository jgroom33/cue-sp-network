...
// 2x PE, 4x P, 2x RR, 2x ASBR, 3x AGG, 4x NID, 4x CE, 1x PCE, 1x EXTERNAL = 23 devices
...
devices: ["pe1", "pe2", "p1", "p2", "p3", "p4", "rr1", "rr2", "asbr1", "asbr2", "agg1", "agg2", "agg5", "nid1", "nid2", "enni1", "enni2", "ce1", "ce2", "ce3", "ce4", "pce1", "isp-upstream"]
